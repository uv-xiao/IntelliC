...
- capability-typed composition (`docs/design/feats/01_extensibility.md`)
- pass tracing and dumps (`docs/design/feats/09_debuggability.md`)
...
- Triton’s warp specialization shows “attrs as APIs” and phase-coupled pipelines that are correct but non-obvious to extend
  safely; see `docs/design/reports/retargetable_extensibility_report.md`.
