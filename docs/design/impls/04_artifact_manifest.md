...
- `islands`:
  - list of `{island_id, dir}` for optional extension-owned island evidence under `islands/`
- `digests`:
...
- per-stage dumps:
  ...
  - optional `ir/stages/<id>/islands/<island_id>/...` (extension-owned round-trip evidence)
