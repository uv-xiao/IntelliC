...
class PassContract:
    ...
    def analysis(
        ...
        *,
        ...
        requires_layout_invariants: tuple[str, ...] | list[str] | None = None,
        requires_effect_invariants: tuple[str, ...] | list[str] | None = None,
        establishes_layout_invariants: tuple[str, ...] | list[str] | None = None,
        establishes_effect_invariants: tuple[str, ...] | list[str] | None = None,
        ...
        return cls(
            ...
            requires_layout_invariants=_normalize_many(requires_layout_invariants),
            requires_effect_invariants=_normalize_many(requires_effect_invariants),
            establishes_layout_invariants=_normalize_many(establishes_layout_invariants),
            establishes_effect_invariants=_normalize_many(establishes_effect_invariants),
