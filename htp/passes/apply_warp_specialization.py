...
from htp.passes.program_model import apply_warp_role_plan, stage_payloads_from_program
from htp.passes.replay_program import render_program_state_module

PASS_ID = "htp::apply_warp_specialization@1"
...
CONTRACT = PassContract(
    ...
    kind="transform",
    ast_effect="mutates",
    requires=("Analysis.WarpRolePlan@1", "Schedule.Applied@1"),
    provides=("Schedule.WarpSpecialized@1",),
...
def run(
    ...
    next_program["schedule"] = apply_warp_role_plan(
    ...
    return next_module, PassResult(
        ...
        digests={"schedule_hash": "demo-warp-specialized-v1"},
        time_ms=0.2,
    )
